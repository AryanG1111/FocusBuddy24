...
class _ArticlesWidgetState extends State<ArticlesWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'articles'});
              ...
              StreamBuilder<List<ArticlesRecord>>(
                stream: queryArticlesRecord(
                  queryBuilder: (articlesRecord) =>
                      articlesRecord.orderBy('sentiment', descending: true),
                  limit: 4,
                ),
                    ...
                    itemBuilder: (context, listViewIndex) {
                      ...
                      return Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ARTICLES_PAGE_Row_rmt2mgf9_ON_TAP');
                            ...
                            context.pushNamed(
                              ...
                              queryParameters: {
                                ...
                                'summary': serializeParam(
                                  listViewArticlesRecord.summary,
                                  ParamType.String,
                                ),
                                'articleLink': serializeParam(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image: Image.network(
                                        listViewArticlesRecord.imageLink,
                                      ).image,
                                    ),
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          listViewArticlesRecord.authors.first,
                                          'none',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium,
