...
class _OnboardingCreateAccountWidgetState
  ...
  void initState() {
    ...
    _model.taskCodeController ??= TextEditingController();
    _model.taskCodeFocusNode ??= FocusNode();
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: _model.taskCodeController,
                                focusNode: _model.taskCodeFocusNode,
                                autofillHints: [AutofillHints.newPassword],
                                textInputAction: TextInputAction.done,
                                obscureText: !_model.taskCodeVisibility,
                                decoration: InputDecoration(
                                  enabledBorder: OutlineInputBorder(
                                    borderSide: BorderSide(
                                      color: FlutterFlowTheme.of(context)
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primary,
                                validator: _model.taskCodeControllerValidator
                                    .asValidator(context),
                              ),
                            ],
                          ),
