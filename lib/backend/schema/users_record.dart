...
class UsersRecord extends FirestoreRecord {
  ...
  // "parent_password" field.
  String? _parentPassword;
  String get parentPassword => _parentPassword ?? '';
  bool hasParentPassword() => _parentPassword != null;

  // "filters" field.
  List<String>? _filters;
  List<String> get filters => _filters ?? const [];
  ...
  void _initializeFields() {
    ...
    _parentPassword = snapshotData['parent_password'] as String?;
    _filters = getDataList(snapshotData['filters']);
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        e1?.coins == e2?.coins &&
        e1?.parentPassword == e2?.parentPassword &&
        listEquality.equals(e1?.filters, e2?.filters) &&
