...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF9E9E9E);
  late Color tertiary = const Color(0xFF607D8B);
  late Color alternate = const Color(0xFFB0BEC5);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF757575);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF5F5F5);
  late Color accent1 = const Color(0xFFFF8A65);
  late Color accent2 = const Color(0xFF9575CD);
  late Color accent3 = const Color(0xFF4DB6AC);
  late Color accent4 = const Color(0xFFFFD54F);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF145DA0);
  late Color secondary = const Color(0xFF757575);
  late Color tertiary = const Color(0xFF455A64);
  late Color alternate = const Color(0xFF90A4AE);
  ...
  late Color accent1 = const Color(0xFFFF5A36);
  late Color accent2 = const Color(0xFF65499D);
  late Color accent3 = const Color(0xFF00867D);
