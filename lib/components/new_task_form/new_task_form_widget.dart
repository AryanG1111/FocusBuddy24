...
export 'new_task_form_model.dart';
...
class _NewTaskFormWidgetState extends State<NewTaskFormWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewTaskFormModel());
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'NEW_TASK_FORM_COMP_SUBMIT_BTN_ON_TAP');
                                  ...
                                  setState(() {
                                    FFAppState().addToTaskList(TaskStruct(
